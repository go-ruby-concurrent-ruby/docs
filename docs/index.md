# go-ruby-concurrent-ruby documentation

**Pure-Go, MRI-4.0.5-faithful Ruby concurrent-ruby (no cgo)**

`go-ruby-concurrent-ruby/concurrent-ruby` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `concurrent-ruby`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-concurrent-ruby/concurrent-ruby`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `concurrent-ruby`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`concurrent-ruby`](https://github.com/go-ruby-concurrent-ruby/concurrent-ruby) | the library — Ruby's `concurrent-ruby` in pure Go |
| [`docs`](https://github.com/go-ruby-concurrent-ruby/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-concurrent-ruby.github.io`](https://github.com/go-ruby-concurrent-ruby/go-ruby-concurrent-ruby.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-concurrent-ruby/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-concurrent-ruby/concurrent-ruby](https://github.com/go-ruby-concurrent-ruby/concurrent-ruby).
